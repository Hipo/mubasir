...
import mubasir.users.managers
import mubasir.users.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default=mubasir.users.models.generate_string_unique_id, max_length=255, unique=True)),
            ...
            managers=[
                ('objects', mubasir.users.managers.UserManager()),
            ],
        ),
    ]
